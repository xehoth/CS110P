...
logisim_location = os.path.abspath(os.path.join(logisim_location,"logisim-evolution.jar"))
...
class TestCase():
  ...
  def __call__(self, filename):
    ...
    proc = subprocess.Popen(["java.exe","-jar",logisim_location,"-noupdates","-tty","table",self.circfile], stdin=stdinf, stdout=subprocess.PIPE)
    try:
